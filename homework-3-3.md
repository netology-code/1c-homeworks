...
Создать форму с полями формы различных типов.

### Требование к результату

Форма внешней обработки с полями формы, привязанными к разным типам элементов управления.
...
<p align="center" width="100%">
  <img src="Examples/img/example-3-3-1.gif"> 
</p>
...
10. Сделайте так, чтобы команда «Применить» выдавала ошибку, если поле «НовоеЗначение» не заполнено, при этом вторая форма закрываться не должна. Т.е. если пользователь оставляет НовоеЗначение пустым, нажимает «Применить» - выводится предупреждение об ошибке, форма остается открытой, для исправления ошибки
...
<p align="center" width="100%">
  <img src="Examples/img/example-3-3-2.gif"> 
</p>
...
<p align="center" width="100%">
  <img src="Examples/img/example-3-3-3.gif"> 
</p>