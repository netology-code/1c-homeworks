...
4. В конфигураторе, в отборе динамического списка установите отбор по умолчанию ПометкаУдаления — Равно — Ложь. 
...
Дать пользователю возможность подбирать номенклатуру в документы "Поступление товаров и услуг" и "Реализация товаров и услуг" не по одному значению, а сразу списком. Реализовать кнопку Подбор в форме документов.
...
5. В поле "Оформление" укажите цвет фона - для поступлений товаров - Красный, для Реализаций - Зеленый.
...
4. В форме документов есть таблица кнопка «Подбор» в командной панели табличной части, открывающая форму выбора справочника «Номенклатура» в режиме подбора. Результат подбора не должен содержать дублей номенклатуры.
