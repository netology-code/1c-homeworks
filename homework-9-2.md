...
2. Подготовьте обработку для заполнения регистра сведений **Календарь** и заполните его за текущий год.

3. В плане видов расчета **НачисленияУдержания**:

Добавьте предопределенные виды расчетов **Больничный** и **Отпуск** как вытесняющие для вида расчета **ОплатаПоОкладу**.

4. Добавьте документ **НачислениеПоОкладу**.
...
5. В модуле документа создайте обработку проведения документа, в которой:
...
6. Заполните и проведите документ. Удостоверьтесь в том, что движения по регистру формируются по окладу в отсутствие вытесняющих оклад начислений (больничного, отпуска), и уменьшаются согласно дням неявки.

### Порядок проверки

1. Запустите приложение в пользовательском режиме
2. Убедитесь, что регистр сведений **Календарь** заполнен за текущий год
3. Убедитесь, что для вида расчета **ОплатаПоОкладу** виды расчета **Больничный** и **Отпуск** являются вытесняющими
4. Создайте сотрудников **Иванов Иван** и **Петров Петр**, установите оклады
5. Введите для сотрудника **Иванов Иван** больничный на однй неделю в начале текущего месяца и отпуск на одну неделю в конце текущего месяца с помощью документа **НачислениеСписком**
6. Начислите сотрудника **Иванов Иван** и **Петров Петр** оплату по окладу за текущий месяц с помощью документа **НачислениеПоОкладу**
7. Убедитесь, что сотруднику **Иванов Иван** начислен оклад, пропорционально уменьшенный на дни больничного и отпуска, что сотруднику **Петров Петр** начислен полный оклад
