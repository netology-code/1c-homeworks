...
То есть, должна быть 1 проводка 62 - 90.1 на общую сумму продаж и столько проводок 90.2 - 41, сколько номенклатуры с типом Товар в таблице документа, каждая на сумму себестоимости этой номенклатуры.
...
* Добавит движение в Дт предопределенного счета Расходы и в Кт счета Товары на сумму списания каждого товара (для услуг проводка формироваться не должна).
* Запишет движения.

Обязательно введите данные в базу (перепроведите документы, чтобы в регистре были записаны проводки.
