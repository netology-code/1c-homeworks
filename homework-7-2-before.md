# Самостоятельное задание "Публикация базы на веб-сервере"
...
3. Скачайте дистрибутив веб-сервера Apache с сайта https://www.apachelounge.com/download/VS17/. При этом если платформа 64-битная, то нужно скачать сервер с приставкой "x64", если 32-битная, то без нее.
