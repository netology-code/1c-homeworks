...
1. Скачайте и установите дистрибутив платформы "1С-Предприятие" (https://developer.1c.ru/).
...
## Зачет
1. Решение является выгрузкой пустой информационной базы в формате .dt с предоставленной в задании конфигурацией

## На доработку
1. Решение предоставлено в формате, отличном от .dt
2. Решение содержит данные, база не пустая
3. Решение развернуто на конфигурации, отличной от приведенной в задании
